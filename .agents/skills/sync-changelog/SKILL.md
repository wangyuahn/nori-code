---
name: sync-changelog
description: Use after a release succeeds, when maintainers need to sync apps/nori-code/CHANGELOG.md into docs/en/release-notes/changelog.md and docs/zh/release-notes/changelog.md, then open a PR on a dedicated branch.
---
...
- The top of `apps/nori-code/CHANGELOG.md` contains version blocks that are not yet in `docs/en/release-notes/changelog.md`.
...
| File | Role | Edited by |
|---|---|---|
| `apps/nori-code/CHANGELOG.md` | **Only upstream source**, generated by changesets | Never edit manually |
...
- The top of `apps/nori-code/CHANGELOG.md` is that new version.
...
```bash
rg '^## ' apps/nori-code/CHANGELOG.md | head -5
...
```text
docs(changelog): sync <version range> from apps/nori-code/CHANGELOG.md
```
...
- Synced `<version range>` from `apps/nori-code/CHANGELOG.md` into `docs/en/release-notes/changelog.md`
...
- Never edit upstream `apps/nori-code/CHANGELOG.md`.
...
| Mistake | Fix |
|---|---|
| Adding entries directly to the English docs page without reading upstream | Use `apps/nori-code/CHANGELOG.md` as the source |
...
- The top version in `apps/nori-code/CHANGELOG.md` is not published on npm or GitHub Releases.
- You are about to edit `apps/nori-code/CHANGELOG.md`.
