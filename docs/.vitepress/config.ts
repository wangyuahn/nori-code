...
const config = withMermaid(defineConfig({
  base,
  title: 'Nori Code CLI Docs',
  description: 'Nori Code CLI Documentation',
  ...
  locales: {
    zh: {
      ...
      lang: 'zh-CN',
      link: '/zh/',
      title: 'Nori Code CLI 文档',
      description: 'Nori Code CLI 用户文档',
      themeConfig: {
        nav: [
    ...
    en: {
      ...
      link: '/en/',
      title: 'Nori Code CLI Docs',
      description: 'Nori Code CLI User Documentation',
      themeConfig: {
        nav: [
