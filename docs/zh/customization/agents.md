...
Nori Code CLI 2.0 中，主 Agent 还领导一棵由 **`TeamCreate`** 雇佣的持久**团队伙伴**组成的**部门树**。伙伴是会话内 Agent，在会话地图上显示为成员卡片；它们参与 Discuss、接收任务并执行，而负责人默认保持只读。有界委派仍使用临时 **SubAgent**，归档在父会话目录内。完整流程见[团队工程](../guides/team-engineering.md)。
