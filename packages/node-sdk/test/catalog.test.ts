...
describe('fetchCatalog', () => {
  it('fetches and returns the catalog map', async () => {
    ...
    const result = await fetchCatalog('https://x/api.json', { fetchImpl: fetchMock as unknown as typeof fetch });
  ...
  it('sends the given User-Agent, and none by default', async () => {
    ...
    expect(withUaHeaders['User-Agent']).toBe('nori-code-cli/1.2.3');
