...
| `04-stateless-controls.ts` | Per-request stateless prompt controls diff-dispatch into the session shadow, including Discuss mode and permission mode transitions. |
