/**
 * Re-export the envelope helpers from `@nori-code/protocol`.
 *
 * The wire-shape source of truth lives in `@nori-code/protocol`. Re-exporting
 ...
 */
export { okEnvelope, errEnvelope, type Envelope } from '@nori-code/protocol';
