...
const DEFAULT_TITLE = 'Nori Code WebSocket API';
...
export function createAsyncApiDocument(
  ...
  return {
    ...
    info: {
      ...
      version,
      description:
        'WebSocket protocol for Nori Code daemon control frames, acknowledgements, system frames, and session event streaming.',
    },
    ...
    servers: {
      local: {
        ...
        pathname: wsPath,
        description: 'Nori Code daemon WebSocket endpoint.',
      },
    },
    channels: {
      [CHANNEL_ID]: {
