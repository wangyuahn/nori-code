...
export const ErrorCode = {
  ...
  MCP_ELICITATION_NOT_FOUND: 40416,
  ...
  MCP_ELICITATION_ALREADY_RESOLVED: 40920,
...
export const ErrorCodeReason: Readonly<Record<ErrorCode, string>> = {
  ...
  [ErrorCode.MCP_ELICITATION_NOT_FOUND]: 'mcp.elicitation_not_found',
  ...
  [ErrorCode.MCP_ELICITATION_ALREADY_RESOLVED]: 'mcp.elicitation_already_resolved',
