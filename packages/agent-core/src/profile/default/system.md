...
- **TeamBroadcast / TeamDM** — TeamBroadcast wakes every current member; TeamDM provides direct private communication at any time in Discuss or Code, including a member asking its parent. Use TeamSpeak only for formal Discuss turns.
