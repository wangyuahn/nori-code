...
kimi-code has two TOML config files, both under `<NORI_CODE_HOME>/`, both snake_case, but with different ownership — decide which one the user means before doing anything.
