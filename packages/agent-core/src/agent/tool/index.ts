  ...
  initializeBuiltinTools() {
    ...
    this.builtinTools = new Map(
      [
        ...
        this.agent.subagentHost && new b.TeamChatTool(this.agent.subagentHost),
        ...
        this.agent.subagentHost && new b.SessionSearchTool(this.agent.subagentHost),
        this.agent.subagentHost && new b.SessionMountTool(this.agent.subagentHost),
        this.agent.subagentHost && new b.SessionUnmountTool(this.agent.subagentHost),
        this.agent.subagentHost && new b.SessionGraphTool(this.agent.subagentHost),
