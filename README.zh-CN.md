...
> [!NOTE]
> 最新发布说明见 [CHANGELOG.md](CHANGELOG.md) 的 `v2.0.1`。委派模型仍以 `v2.0.0` 为准。更早条目里的 SubAgent、DAG、`nori_swarm_launch` 描述的是已经拿掉的路径。
...
Nori Work 提供**独立安装包**：[Releases](https://github.com/wangyuahn/nori-code/releases)。当前桌面标签是 **2.0.1**；**委派模型以 v2 changelog 和这份 README 为准**。
