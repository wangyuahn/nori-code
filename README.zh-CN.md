...
> [!WARNING]
> **v1.0.0-pre.1 是预发布版本，不是正式稳定的 1.0 版本。** 该版本用于提前验证扩展后的 Nori Work 桌面工作流。测试前请备份重要工作，并通过 [GitHub Issues](https://github.com/wangyuahn/nori-code/issues) 反馈回归问题。
...
Nori Work 桌面版为**独立安装包**。当前预览版为 [v1.0.0-pre.1](https://github.com/wangyuahn/nori-code/releases/tag/v1.0.0-pre.1)；稳定版本仍可在 [Releases](https://github.com/wangyuahn/nori-code/releases) 获取。
