...
export function SessionMapPage({
  ...
  // Escape: wire → marquee → draft (even while typing in draft INPUT) → menus/editors/selection.
  useEffect(() => {
  ...
  }, [activeLabelIds, byId, listMembers, mapDoc.sessionLabels, mapDoc.topLevelRoles, query]);
