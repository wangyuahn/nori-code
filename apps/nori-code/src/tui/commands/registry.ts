...
export const BUILTIN_SLASH_COMMANDS = [
  {
    name: 'yolo',
    aliases: ['yes'],
    description: 'Deprecated — use /setting permission yolo',
    priority: 60,
    availability: 'always',
  },
  {
    name: 'auto',
    aliases: [],
    description: 'Deprecated — use /setting permission auto',
    priority: 60,
    availability: 'always',
  },
  {
  ...
  },
  {
    name: 'feedback',
    aliases: [],
    description: 'Send feedback to make Nori Code better',
    priority: 60,
    availability: 'always',
  },
  {
