...
export type SubAgentProgressEstimatorPhase =
  | 'pending'
  | 'queued'
  | 'suspended'
  | 'running'
...
export interface SubAgentProgressEstimatorOptions {
...
export interface SubAgentProgressEstimateInput {
  readonly memberKey: string;
  readonly phase: SubAgentProgressEstimatorPhase;
  readonly capacityTicks: number;
  readonly nowMs: number;
}

export interface SubAgentProgressEstimate {
...
export class SubAgentProgressEstimator {
  ...
  constructor(options: SubAgentProgressEstimatorOptions = {}) {
  ...
  estimate(input: SubAgentProgressEstimateInput): SubAgentProgressEstimate {
    const state = this.getOrCreateMember(input.memberKey);
  ...
  estimateAll(
    inputs: readonly SubAgentProgressEstimateInput[],
  ): Map<string, SubAgentProgressEstimate> {
    const estimates = new Map<string, SubAgentProgressEstimate>();
